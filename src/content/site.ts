...
export const portfolio = {
  ...
  companies: [
    // Fund I — Beyond Impact Venture Partners (BIVP)
    { name: "Algama", sector: "Nutrition", fund: "Fund I & II", region: "EU", desc: "Harnessing the potential of algae for food that's good for people and planet." },
    { name: "BlueNalu", sector: "Nutrition", fund: "Fund I", region: "US", desc: "Global leader in cellular aquaculture — cell-cultured seafood." },
    { name: "Emulate", sector: "Health", fund: "Fund I", region: "US", desc: "Boston-based developer of Organs-on-Chips technology." },
    { name: "EVERY", sector: "Ingredients", fund: "Fund I", region: "US", desc: "Animal-free egg proteins via precision fermentation." },
    { name: "Geltor", sector: "Ingredients", fund: "Fund I & II", region: "US", desc: "Biomimetic proteins for skin care and food & beverage." },
    { name: "Gourmey", sector: "Nutrition", fund: "Fund I & II", region: "EU", desc: "France's pioneering cultivated meat company crafting high-end delicacies." },
    { name: "Konscious Foods", sector: "Nutrition", fund: "Fund I", region: "NA", desc: "Maker of the world's first frozen plant-based sushi rolls, onigiri and poke bowls." },
    { name: "Jay & Joy / LNA", sector: "Nutrition", fund: "Fund I & II", region: "EU", desc: "Plant-based fermented cheeses — delicious, healthy and affordable." },
    { name: "PLHYDE", sector: "Materials", fund: "Fund I", region: "EU", desc: "Luxury leather from food waste — no plastic, no animals." },
    { name: "Mosa Meat", sector: "Nutrition", fund: "Fund I", region: "EU", desc: "Pioneers of lab-grown beef and cellular agriculture." },
    { name: "Plant Veda", sector: "Nutrition", fund: "Fund I", region: "NA", desc: "Probiotic plant-based dairy manufacturing." },
    { name: "Renewal Mill", sector: "Ingredients", fund: "Fund I & II", region: "US", desc: "Award-winning upcycled food company turning byproducts into pantry staples." },
    { name: "Umami Bioworks", sector: "Nutrition", fund: "Fund I", region: "APAC", desc: "AI-powered cultivated seafood and marine ingredients." },
    { name: "SuperMeat", sector: "Nutrition", fund: "Fund I", region: "Israel", desc: "Cultured chicken meat from cell cultivation." },
    { name: "SwissDecode", sector: "Health", fund: "Fund I", region: "EU", desc: "Onsite analysis of biological material to detect animal DNA." },
    // Fund II only
    { name: "Ingrediome", sector: "Ingredients", fund: "Fund II", region: "Israel", desc: "Recombinant animal proteins made from CO₂ via cyanobacterial precision fermentation." },
    { name: "Paleo", sector: "Ingredients", fund: "Fund II", region: "EU", desc: "Animal-free, bio-identical heme proteins including myoglobin." },
    { name: "TissenBioFarm", sector: "Nutrition", fund: "Fund II", region: "APAC", desc: "Premium whole-cut cultivated meats including Wagyu beef and Hanwoo." },
    { name: "YeastUp", sector: "Ingredients", fund: "Fund II", region: "EU", desc: "Transforming spent yeast biomass into premium proteins and fibres." },
    { name: "Perfat", sector: "Ingredients", fund: "Fund II", region: "EU", desc: "Healthier structured fats reformulating products from Nutri-Score D to A." },
  ],
};
